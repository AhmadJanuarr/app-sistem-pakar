        ...
        <div class="card-register ">
            ...
            <div class="card-body ">
                <form id="registrationForm" method="POST" action="function.php?act=register" class="needs-validation" novalidate>
                    ...
                    <button type="submit" name="submitButton" id="submitButton" class="registerbtn btn btn-primary btn-block">Register</button>
                    <br>
                    <div class="card-footer text-muted">
                        Sudah punya akun? <a href="index.php">Log In</a>
                    </div>
                </form>
            </div>
        </div>
