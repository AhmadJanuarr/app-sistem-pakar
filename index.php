...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item ">
            ...
            <button type="button" class="btn btn-secondary btn-login" data-toggle="modal" data-target="#exampleModal">Log In</button>
            </button>
                  ...
                  <div class="modal-body">
                    <form id="login-form" action="function.php?act=login" method="POST">
                      ...
                      <div class="modal-footer">
                        <input type="submit" name="login_btn" id="login" class="btn btn-primary" value="Log in">
                      </div>
                    </form>
                  </div>
                </div>
    ...
    <div class="container-xl">
      <div class="row position-relative">
        <div class="col align-self-center">
          ...
          <h6 class="font-weight-normal">Diagnosa dan Identifikasi Penyakit Ayam Menggunakan Metode Forward Chaining</h6>
          </p>
  ...
  <section id="alur" class="py-5 ">
    <!--Content2-->
    <div class="container-xl">
      <h1 style=" text-align: center;" class="font-weight-normal sub-heading ">Cari Tahu Penyakit Ayam dan Cara mengatasinya</h1>
      <p class="pb-5 text-center font-weight-light">Ikuti pentujuk dibawah ini, agar anda tidak kesulitan di diagnosa penyakit ayam</p>
      <p></p>
  ...
  <section class="py-30 mb-5 container-xl">
    <div class="row margin-top mb-5">
      <div class="col d-flex justify-content-center flex-column text-center mb-5 margin-top">
        ...
        <p class="font-weight-light">Forward Chaining adalah teknik inferensi dalam sistem pakar yang berproses dari fakta awal menuju kesimpulan melalui serangkaian aturan yang cocok.</p>
      </div>
    </div>
    <div class="row mb-5">
      <div class="col-5">
      ...
      <div class="col-7 d-flex justify-content-center flex-column">
        ...
        <p class="font-weight-light">Proses ini melibatkan pengumpulan fakta, penerapan aturan, penambahan informasi baru, iterasi dengan informasi tersebut, dan berlanjut hingga mencapai kesimpulan.</p>
      </div>
    </div>
  </section>
  <section section class="margin-top container-xl">
    <div class="row margin-top d-flex flex-column">
      <div class="col margin-top d-flex justify-content-center flex-column text-center">
        ...
        <p class="font-weight-light">Proses menjawab pertanyaan kunci melibatkan pengumpulan fakta, penerapan aturan, penambahan informasi, iterasi, dan berlanjut hingga kesimpulan untuk respons yang mendalam dan komprehensif.</p>
      </div>
        ...
        <div class="accordion mb-5" id="accordionExample">
          ...
          <div class="card mb-3">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
              <div class="card-body">
                Dalam sistem pakar ini, metode Forward Chaining memulai dengan gejala-gejala yang diamati pada ayam, kemudian menerapkan aturan-aturan yang telah ditetapkan untuk mencapai diagnosa penyakit.
              </div>
            </div>
          </div>
          <div class="card mb-3">
            ...
            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
              <div class="card-body">
                Metode ini dipilih karena kemampuannya untuk menangani situasi dimana informasi awal yang tersedia adalah gejala-gejala yang mudah diamati, dan proses inferensi dapat dilakukan secara sistematis hingga mencapai diagnosa yang tepat.
              </div>
            </div>
          </div>
          <div class="card mb-3">
          ...
          <div class="card mb-3">
            <div class="card-header" id="headingFive">
              <h2 class="mb-0">
                <button class="btn font-weight-bold btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                  Apa tantangan yang dihadapi saat menerapkan Metode Forward Chaining? </button>
              </h2>
            </div>
            <div id="collapseFive" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
              <div class="card-body">
                Tantangan utama adalah memastikan bahwa basis pengetahuan dan aturan yang digunakan lengkap dan akurat, sehingga dapat menghasilkan diagnosa yang tepat. </div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class=" container-xl">
      <div class="row">
        ...
        <div class="col-md-4 mb-3">
          <h5>Tentang </h5>
          <p>Sistem pakar diagnosa penyakit ayam membantu peternak dan dokter hewan mengidentifikasi penyakit, mengambil keputusan perawatan, dan memberikan rekomendasi kesehatan ayam di pertanian ayam.</p>
        </div>
        <!-- Footer Column 2 -->
        <div class="col-md-4 mb-3">
          <h5>Link </h5>
